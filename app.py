...
st.caption("Düzeltilmiş 2 Basamaklı Yüzde Gösterimi, Deterministik Bar Sayacı ve ATR Hedefleri.")
...
if not df.empty:
    ...
    # --- Deterministik Bar Sayacı (Vektörel Çözüm - AttributeError Giderildi) ---
